document.addEventListener('DOMContentLoaded', () => {
    ...
    const carrossel = document.querySelector('.carrosselAnimes');
    const items = Array.from(document.querySelectorAll('.previewAnime'));
    ...
    items.forEach(item => {
        ...
        const linkOriginal = item.closest('a'); //Pega o <a> que está envolvendo o previewAnime
        if(linkOriginal){
