...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($anime->createAnime()) {
        ...
        foreach($genero as $genero_id){
            $anime_genero->setCodAnime($anime_id);
            $anime_genero->setCodGenero($genero_id);        
            $anime_genero->insertAnimeGenero();
        }

        echo "success";
        
    } else {
        echo "Falha ao cadastrar o anime";
    }
