...
//Pegando o id da noticia na URL
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    /*if ($noticia->createNoticia()) {
        ...
        echo "Falha ao editar o noticia";
    }*/

    // Tenta editar a noticia no Bd
    if ($noticia->updateNoticia($noticia_id)) {
        //pegando o id da noticia com uma função PDO que pega o último id inserido no banco
        echo "success";
        
    } else {
        echo "Falha ao editar a noticia";
    }
}
?>
